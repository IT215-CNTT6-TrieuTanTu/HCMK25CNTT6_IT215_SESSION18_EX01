...
@app.post(
    ...
    status_code=201 # Trả về 201 Created khi tạo thành công
)
def create_employee(
    data: EmployeeCreate,
    db: Session = Depends(get_db)
    ...
    # 4. Kiểm tra employee_code trên toàn bộ hệ thống (bỏ filter theo department_id)
    duplicate_employee = (
        db.query(Employee)
